...
{
    public class VBDocument : TextBase, IDocument
    {
        public List<VBNamespace> Namespaces { get; set; }
        public string Name { get; set; }
        public string ProjectName { get; set; }

        public VBDocument(string name, string projectName)
        {
            Namespaces = new List<VBNamespace>();
            Name = name;
